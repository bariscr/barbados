...
```{r}
url <- "https://api.uninfo.org/vx.y/plan/YOUR_PLAN_ID"
...
```{r}
url <- "https://api.uninfo.org/vx.y/sustainableDevelopmentGoal/overviewReport?exclude=organizations&grouping=planEntity&planEntityType=OC&linkTypes=Gender%20Marker&linkTypes=Human%20Rights%20Marker&planIds=YOUR_PLAN_ID"
...
```{r}
url <- "https://api.uninfo.org/vx.y/sustainableDevelopmentGoal/overviewReport?exclude=organizations&grouping=planEntity&planEntityType=OU&linkTypes=Gender%20Marker&linkTypes=Human%20Rights%20Marker&planIds=YOUR_PLAN_ID"
...
```{r}
url <- "https://api.uninfo.org/vx.y/sustainableDevelopmentGoal/overviewReport?exclude=organizations&grouping=planEntity&planEntityType=SOU&linkTypes=Gender%20Marker&linkTypes=Human%20Rights%20Marker&planIds=YOUR_PLAN_ID"
...
```{r}
url <- "https://api.uninfo.org/vx.y/sustainableDevelopmentGoal/overviewReport?exclude=organizations&planIds=YOUR_PLAN_ID"
...
```{r}
url <- "https://api.uninfo.org/vx.y/sustainableDevelopmentGoal/overviewReport?exclude=organizations&grouping=planEntity&planEntityType=SOU&linkTypes=Gender%20Marker&linkTypes=Human%20Rights%20Marker&Sustaining%20Peace%20MarkerHumanitarian%20Marker&planIds=YOUR_PLAN_ID"
...
```{r}
url <- "https://api.uninfo.org/vx.y/plan/public/YOUR_PLAN_ID"
response <- GET(url, headers)
content <- content(response)
...
```{r}
url <- "https://api.uninfo.org/vx.y/plan/evaluate/YOUR_PLAN_ID"
response <- GET(url, headers)
content <- content(response)
